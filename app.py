    ...
    dbc.Row([ 
        ...
        dbc.Col([
            ...
            html.H4("Informe a Data Inicial da Carteira", className = "text-primary",
                    style = {"margin-top": "51px", "text-align":"center"}),
            ...
            html.Div([            
                dcc.DatePickerSingle(
                    ...
                    day_size = 45,
                    style = {"border": "0px solid black", "margin-top": "34px"},
                ),
            ...
            html.Div([
                html.Img(src = image, height = 136),
            ], style = {"display" : "flex", "justifyContent" : "center", "margin-top": "102px","margin-bottom": "102px"}),
        ...
        dbc.Col([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD1", className = "text-light", style = {"text-align":"center", "font-size":"17px"}),
                        dcc.Graph(id = "line-map1", style = {"height": "27vh"}), 
                    ], style = {"margin-top": "17px"}, color = "dark"),
                ], md = 5),

                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD2", className = "text-light", style = {"text-align":"center", "font-size":"17px"}),
            ...
            dbc.Row([
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD3", className = "text-light", style = {"text-align":"center", "font-size":"17px"}),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD4", className = "text-light", style = {"text-align":"center", "font-size":"17px"}),
            ...
            dbc.Row([
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD5", className = "text-light", style = {"text-align":"center", "font-size":"17px"}),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD6", className = "text-light", style = {"text-align":"center", "font-size":"17px"}),
