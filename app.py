    ...
    dbc.Row([ 
        ...
        dbc.Col([
            ...
            html.Div([            
                dcc.DatePickerSingle(
                    ...
                    day_size = 45,
                    style = {"border": "0px solid black", "margin-top": "36px"},
                ),
            ...
            html.Div([
                html.Img(src = image, height = 117),
            ], style = {"display" : "flex", "justifyContent" : "center", "margin-top": "90px","margin-bottom": "90px"}),
        ...
        dbc.Col([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD1", className = "text-light", style = {"text-align":"center", "font-size":"18px"}),
                        dcc.Graph(id = "line-map1", style = {"height": "25vh"}), 
                    ], style = {"margin-top": "18px"}, color = "dark"),
                ], md = 5),

                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD2", className = "text-light", style = {"text-align":"center", "font-size":"18px"}),
            ...
            dbc.Row([
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD3", className = "text-light", style = {"text-align":"center", "font-size":"18px"}),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD4", className = "text-light", style = {"text-align":"center", "font-size":"18px"}),
            ...
            dbc.Row([
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD5", className = "text-light", style = {"text-align":"center", "font-size":"18px"}),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(id = "stockCD6", className = "text-light", style = {"text-align":"center", "font-size":"18px"}),
